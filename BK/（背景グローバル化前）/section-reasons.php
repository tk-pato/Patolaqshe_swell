...
<section id="reasons" class="ptl-section ptl-reasons">
    <div class="ptl-section__inner">
        ...
        <div class="ptl-reasons__grid">
            <?php foreach ($cards as $c): ?>
                <article class="ptl-reason-card is-static">
                    <div class="ptl-reason-card__media" aria-hidden="true">
                        <img src="<?php echo esc_url($c['img']); ?>" alt="" loading="lazy" />
                    </div>
                    <h3 class="ptl-reason-card__title"><?php echo esc_html($c['title']); ?></h3>
                    <p class="ptl-reason-card__desc"><?php echo esc_html($c['desc']); ?></p>
                </article>
            <?php endforeach; ?>
        </div>
