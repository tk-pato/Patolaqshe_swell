...
?>
<!-- child header_contents v3 -->
<header class="l-header" role="banner">
  <?php get_template_part('parts/header/fix_header'); ?>
  <?php get_template_part('parts/header/info_bar'); ?>
  <?php get_template_part('parts/header/head_bar'); ?>     <?php // PC global nav (child hard-coded) ?>
  <?php get_template_part('parts/header/sp_head_nav'); ?>   <?php // SP nav ?>
  <?php get_template_part('parts/header/sp_menu'); ?>
</header>
