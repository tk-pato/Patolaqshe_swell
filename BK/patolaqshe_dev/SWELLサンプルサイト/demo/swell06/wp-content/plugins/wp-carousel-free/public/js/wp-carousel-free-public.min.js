    ...
    jQuery("body").find(".wpcp-carousel-section.wpcp-standard").each((function() {
        ...
        if ("flip" == wpcpSwiperData.effect) {
            function fade_effect(slidesToShow) {
                for (var fade_items = $(`#${carousel_id} .swiper-wrapper >.single-item-fade`), i = 0; i < fade_items.length; i += slidesToShow)
            ...
            $(window).width() > wpcpSwiperData.responsive.desktop ? fade_effect(wpcpSwiperData.slidesToShow.lg_desktop) : $(window).width() > wpcpSwiperData.responsive.laptop ? fade_effect(wpcpSwiperData.slidesToShow.desktop) : $(window).width() > wpcpSwiperData.responsive.tablet ? fade_effect(wpcpSwiperData.slidesToShow.laptop) : $(window).width() > wpcpSwiperData.responsive.mobile ? fade_effect(wpcpSwiperData.slidesToShow.tablet) : $(window).width() > 0 && fade_effect(wpcpSwiperData.slidesToShow.mobile),
        ...
        wpcpSwiperData.pauseOnHover && wpcpSwiperData.autoplay && $("#" + carousel_id).on({
            mouseenter: function() {
