jQuery(document).ready((function($) {
    $(".sp-testimonial-free-section").each((function(index) {
        var _this = $(this),
            ...
            preloader;
        if ("1" == _this.data("preloader")) {
            var parents_class,
                parents_siblings_id = $("#" + custom_id).parent(".sp-testimonial-free-wrapper").find(".sp-testimonial-preloader").attr("id");
            setTimeout((function() {
        ...
        if (SliderData && !$("#" + SliderId + ".sp-testimonial-free-section").hasClass("swiper-initialized")) {
            var TestimonialSwiper = new Swiper("#" + SliderId + ".sp-testimonial-free-section", {
                ...
                navigation: 1 == SliderData.arrows && {
                ...
                breakpoints: {
                    320: {
                        ...
                        navigation: 1 == SliderData.navigation_mobile && {
                            nextEl: "#" + SliderId + " .swiper-button-next.testimonial-nav-arrow",
                            prevEl: "#" + SliderId + " .swiper-button-prev.testimonial-nav-arrow"
                        },
                        pagination: 1 == SliderData.pagination_mobile && {
                            el: "#" + SliderId + " .testimonial-pagination",
                            clickable: !0
                        }
                    },
            ...
            (!1 === SliderData.autoplay || $(window).width() < 576 && 0 == SliderData.autoplay_mobile) && TestimonialSwiper.autoplay.stop(),
            SliderData.pauseOnHover && SliderData.autoplay && $("#" + SliderId).on({
                mouseenter: function() {
