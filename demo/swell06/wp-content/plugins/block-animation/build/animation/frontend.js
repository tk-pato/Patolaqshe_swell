    ...
    window.addEventListener("load", (() => {
        ...
        (t => {
            ...
            if (e = [...new Set(e)], n = [...new Set(n)], 0 < e.length || 0 < n.length) {
                ...
                t.id = "o-anim-custom-values";
                const a = t => t.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g, "\\$1");
                t.innerHTML = e.reduce(((t, e) => {
                    const n = e.replace("o-anim-value-delay-", "");
                    return t + `.animated.${a(e)} { animation-delay: ${n}; -webkit-animation-delay: ${n}; }`
                }), "") + "\n" + n.reduce(((t, e) => {
                    const n = e.replace("o-anim-value-speed-", "");
                    return t + `.animated.${a(e)} { animation-duration: ${n}; -webkit-animation-duration: ${n}; }`
                }), ""),
        ...
        for (const i of d) {
            if (classes = i.classList, i.animationClasses = [], !o(i)) {
                ...
                e && (i.animationClasses.push(e), i.classList.remove(e)),
                o && (i.animationClasses.push(o), i.classList.remove(o)),
                s && (i.animationClasses.push(s), i.classList.remove(s)),
                i.classList.add("hidden-animated")
            }
            if (classes.add("o-anim-ready"), e.forEach((t => {
                ...
                i.classList.remove("hidden-animated"),
                i.classList.remove("animated");
                const {animationName: t} = i.style;
                i.style.animationName = "none",
                i.addEventListener("mouseenter", (() => {
                    i.classList.add("animated"),
                    i.style.animationName = t
                }))
            }
        ...
        const u = [];
        for (const t of d)
            t.animationClasses && 0 < t.animationClasses.length && u.push({
                element: t,
                triggerOffset: i(t)
            });
        window.addEventListener("scroll", (() => {
            requestAnimationFrame((() => {
                const t = [];
                for (const e of u) {
                    const {element: n, triggerOffset: a} = e,
                        {top: o} = n.getBoundingClientRect();
