...
$cards = [
    [
        ...
        'image' => $resolve_image($card1_img, 'https://patolaqshe.com/wp-content/uploads/2026/01/bridal_banner.jpg'),
    ],
    [
        'title' => 'INFORMATION',
        'desc' => '最新のキャンペーン情報やお得なプランをいち早くお届けします。',
        'url' => 'https://patolaqshe.com/informatio/',
        'image' => $resolve_image($card2_img, 'https://patolaqshe.com/wp-content/uploads/2026/01/info_banner.jpg'),
    ],
    [
        'title' => 'FAQ',
