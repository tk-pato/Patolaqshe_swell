// Patolaqshe 銀座店 - 完全版JS（nicescroll + お客様の声リンク化 + ブログモーダル700ms統一 + issues動画背景）
...
(function() {
    ...
    function initCardLinks() {
        ...
        if (mainCard) {
            var bustUrl = 'https://book.squareup.com/appointments/qt8e7316fy17nd/location/CMN5YZFYZARSA/services?filter_category_id=JHUJLU5KLKOZ7VC5YFOXDUSW';
        ...
        btmCards.forEach(function(card) {
            ...
            if (text.indexOf('\u30d5\u30a7\u30a4\u30b7\u30e3\u30eb') !== -1) {
                targetUrl = 'https://book.squareup.com/appointments/qt8e7316fy17nd/location/CMN5YZFYZARSA/services?filter_category_id=FRLQP4YFDNOSEOX6UXZMWEOC';
                isExternal = true;
            } else if (text.indexOf('\u30dc\u30c7\u30a3') !== -1) {
                targetUrl = 'https://book.squareup.com/appointments/qt8e7316fy17nd/location/CMN5YZFYZARSA/services?filter_category_id=AFTPPINBRY34HVLH6DMNHQW7';
                isExternal = true;
            } else {
                isModal = true;
            }
