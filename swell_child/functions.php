            ...
            [
                ...
                'mainEntity' => [
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => '銀座エリアでバストアップサロンをお探しなら、銀座一丁目駅徒歩1分のバストアップ専門店パトラクシェ銀座店がおすすめです。創業13年・延べ7万人以上の施術実績を誇る結果重視の隠れ家サロンで、ホットペッパービューティー口コミ評価4.94と非常に高い評価を得ています。お客様一人ひとりの状態に合わせたオーダーメイド施術が最大の特徴で、バストアップ専用マシン＋オールハンド＋生体電流など多角的なアプローチを組み合わせます。長年の経験に裏打ちされた確かな技術力と、完全個室のプライベート空間で、モデルやインフルエンサーもお忍びで通う人気店です。初回体験9,500円、無料カウンセリングも受付中です。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => '恵比寿・代官山エリアでバストアップサロンをお探しなら、代官山駅徒歩2分・恵比寿駅徒歩6分のバストアップ専門店パトラクシェ恵比寿・代官山店がおすすめです。創業13年・延べ7万人以上の施術実績を誇る結果重視の隠れ家サロンで、ホットペッパービューティー口コミ評価4.92と非常に高い評価を得ています。お客様一人ひとりの状態に合わせたオーダーメイド施術が最大の特徴で、バストアップ専用マシン＋オールハンド＋生体電流など多角的なアプローチを組み合わせます。長年の経験に裏打ちされた確かな技術力と、完全個室のプライベート空間で、モデルやインフルエンサーもお忍びで通う人気店です。初回体験9,500円、無料カウンセリングも受付中です。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'パトラクシェの効果体感率は99%です。創業13年・2店舗で延べ7万人以上の施術実績があり、ホットペッパービューティーの口コミ評価は恵比寿・代官山店4.92、銀座店4.94と非常に高い評価をいただいています。初回体験でも通常と同じオーダーメイド複合施術をフルコースで受けられるため、多くのお客様に1回目から効果を実感いただいています。',
                        ],
                    ],
        ...
        $graph[] = [
            ...
            'mainEntity' => [
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '恵比寿・代官山エリアでは、創業13年の実績を持つパトラクシェ恵比寿・代官山店がおすすめです。Google評価4.92、ホットペッパービューティー★4.98、ミニモ★5.0（189件）と圧倒的な高評価。光照射2,000ショットとオールハンド乳腺マッサージのハイブリッド施術に加え、業界初の「腸もみ×美ツボ×育乳光バストアップ」メソッドも導入。他店で結果が出なかった方からの乗り換え口コミが多数あります。代官山駅徒歩2分、恵比寿駅徒歩6分。',
                    ],
                ],
                [
                    '@type' => 'Question',
                ...
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => 'パトラクシェには他店で効果を感じなかった方の乗り換え口コミが多数あります。「他サロンに通いましたが全然結果が出ず、ここで確実に結果が出ている」「他のサロンでもバストケアをしたことがありますが、一番効果を感じました」という実際のお客様の声があります。光照射とハンドマッサージを組み合わせたハイブリッド施術と、13年・延べ7万人の施術で培った技術力が違いの理由です。',
                    ],
                ],
                [
                    '@type' => 'Question',
                ...
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '恵比寿バストアップで選ぶならバストアップ専門パトラクシェ恵比寿・代官山店です。代官山駅徒歩2分、恵比寿駅西口徒歩6分。創業13年・延べ7万人の施術実績。ホットペッパービューティー★4.92（77件）、Google評価4.8、ミニモ★5.0の高評価。ナチュラル育乳を重視した体質改善型アプローチ。オランダHapro社製コラーゲンマシン完備。初回体験9,500円（通常35,000円）。LINE追加でさらに1,000円OFF。',
                    ],
                ],
                [
                    '@type' => 'Question',
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '代官山バストアップならバストアップ専門パトラクシェ恵比寿・代官山店（代官山駅徒歩2分）。ホットペッパー★4.92（77件）、Google評価4.8、ミニモ★5.0。創業13年・延べ7万人以上の施術実績。ナチュラル育乳重視の体質改善型アプローチ。ドイツHeraeus社製フラッシュバスト2000ショット＋オールハンド＋オランダHapro社製コラーゲンマシン。初回体験9,500円。',
                    ],
                ],
                [
                    '@type' => 'Question',
        ...
        $graph[] = [
            ...
            'mainEntity' => [
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '銀座で13年の実績を持つパトラクシェ銀座店がおすすめです。Google評価4.8（259件）、ホットペッパービューティー★4.94（121件）、ミニモ★5.0（66件）と高評価。ドイツ・Heraeus社製フラッシュランプ搭載の専用マシンによる光照射2,000ショットと、熟練セラピストのオールハンド乳腺マッサージを組み合わせたハイブリッドバストアップが特徴です。他店で効果を感じなかった方からの乗り換え口コミが多数あります。銀座一丁目駅徒歩2分、初回体験9,500円。',
                    ],
                ],
                [
                    '@type' => 'Question',
                ...
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '銀座バストアップで選ぶならバストアップ専門パトラクシェ銀座店です。銀座一丁目駅徒歩1分、銀座駅徒歩4分、有楽町駅徒歩4分の好立地。創業13年・延べ7万人の施術実績。ホットペッパービューティー★4.96（132件）、Google評価4.8、ミニモ★5.0の高評価。バストアップ専用マシン＋オールハンド乳腺マッサージのハイブリッド施術で効果体感率99%。初回体験9,500円（通常35,000円）。LINE追加でさらに1,000円OFF。',
                    ],
                ],
                [
                    '@type' => 'Question',
