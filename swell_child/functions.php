            ...
            [
                ...
                'mainEntity' => [
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'はい、LINE公式アカウント「パトラクシェ初回特典」を友だち追加いただくと、初回限定1,000円OFFクーポンをご利用いただけます。ホットペッパービューティーの通常クーポンと併用可能で、さらにお得にご体験いただけます。なお、期間限定キャンペーンクーポンとの併用はできませんのでご了承ください。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => '一番人気のバストアップコース（90分）は初回9,500円（税込）です。カウンセリング＋フラッシュバスト2000ショット＋乳腺マッサージ＋ナノカレントなど、通常と同じオーダーメイド複合施術をフルコースでご体験いただけます。LINE友だち追加クーポンをご利用いただくと8,500円でご体験可能です。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'はい、各店舗ごとにLINE公式アカウントがあります。恵比寿・代官山店（@patolaqshe）、銀座店（@patolaqshe-ginza）からご予約やお問い合わせが可能です。お気軽に友だち追加してご連絡ください。',
                        ],
                    ],
                    // --- 求人関連FAQ（求職者向け） ---
                    [
