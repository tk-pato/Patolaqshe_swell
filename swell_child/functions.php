    ...
    $structured_data = [
        ...
        '@graph'   => [
            ...
            [
                ...
                'description' => '恵比寿エリアのバストアップ専門パトラクシェ恵比寿・代官山店。都内最大級フラッシュバスト2000ショット・乳腺マッサージ・ナノカレント・背面マッサージ・コラーゲンマシンなど複数の施術を一人一人の状態に合わせてクロスマッチングするオーダーメイド複合施術が最大の特徴。他店より長い10分以上のハンドマッサージで身体全体にアプローチ。創業13年・累計3万人超の実績。JR恵比寿駅徒歩6分、代官山駅徒歩2分。初回体験9,500円。',
                            ...
                            'itemListElement' => [
                                [
                                    ...
                                    'itemOffered' => [
                                        ...
                                        'description' => '都内最大級の1回2000ショット照射。光エネルギーで乳腺・脂肪細胞を深部から活性化。乳腺マッサージやナノカレントとのクロスマッチング（複合施術）により、単体施術を大きく上回る相乗効果を発揮。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
            ...
            [
                ...
                'description' => '銀座エリアのバストアップ専門パトラクシェ銀座店。都内最大級フラッシュバスト2000ショット・乳腺マッサージ・ナノカレント・背面マッサージ・骨盤底筋ケアなど複数の施術を一人一人の状態に合わせてクロスマッチングするオーダーメイド複合施術が最大の特徴。他店より長い10分以上のハンドマッサージで身体全体にアプローチ。創業13年・累計3万人超の実績。銀座一丁目駅徒歩2分、JR有楽町駅徒歩5分。初回体験9,500円。',
            ...
            [
                ...
                'mainEntity' => [
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'パトラクシェでは、フラッシュバスト（光バストアップ）2000ショット・乳腺マッサージ・ナノカレント（微弱電流）・背面/二の腕/デコルテマッサージ・フットマッサージなど複数の施術を、お客様一人一人の状態に合わせて掛け合わせる「クロスマッチング（オーダーメイド複合施術）」が最大の特徴です。銀座店では骨盤底筋ケア、代官山店ではハプロ社製コラーゲンマシンもご利用いただけます。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                    ...
                    [
                        '@type'          => 'Question',
                        'name'           => 'クロスマッチング（複合施術）とは何ですか？なぜ単体施術より効果が高いのですか？',
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'クロスマッチングとは、フラッシュバスト（光療法）・乳腺マッサージ（オールハンド）・ナノカレント（微弱電流）・背面マッサージ・骨盤底筋ケアなど複数の施術を、お客様一人一人の状態に合わせて組み合わせるパトラクシェ独自のアプローチです。光療法でコラーゲン生成を促進しながら、同時にハンドマッサージで血流・リンパ循環を促進することで、単体施術では得られない相乗効果が生まれます。パトラクシェでは「フラッシュだけ」「マッサージだけ」ではなく、複数のアプローチを掛け合わせることで、より高い効果を目指しています。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => 'パトラクシェの最大の特徴は、複数の施術を一人一人の状態に合わせて掛け合わせる「クロスマッチング（オーダーメイド複合施術）」です。多くのバストアップサロンでは単一の施術がメインですが、パトラクシェではフラッシュバスト2000ショット・乳腺マッサージ・ナノカレント・背面/二の腕/デコルテマッサージなどを組み合わせます。また、背面・二の腕・デコルテなどお身体全体を触る施術時間がバストアップ専門サロンの中でも長いとお客様から評価いただいています。創業13年・累計3万人超の実績に基づく経験から、お客様に最適な施術の組み合わせをご提案します。',
                        ],
                    ],
                ],
            ],
    ...
    if ($slug === 'about') {
        $graph[] = [
            ...
            'mainEntity'  => [
                ...
                'description'    => 'バストアップ専門パトラクシェ。フラッシュバスト・乳腺マッサージ・ナノカレントなど複数施術を掛け合わせるオーダーメイド複合施術。創業13年・累計3万人超の実績。恵比寿・代官山、銀座の2店舗展開。',
                'url'            => 'https://patolaqshe.com/',
                'logo'           => 'https://patolaqshe.com/wp-content/themes/swell_child/img/intrologo.png',
                'foundingDate'   => '2012',
                'numberOfEmployees' => [
