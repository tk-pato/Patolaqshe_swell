                            ...
                            'itemListElement' => [
                                ...
                                [
                                    ...
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => '乳腺マッサージ',
                                        'description' => '熟練のオールハンドで乳腺を丁寧にほぐし、血流・リンパ循環を促進してバストの成長をサポート。10分以上の施術時間を確保し、他店の約2倍の時間をかけてお身体全体にアプローチ。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
                                ...
                                [
                                    ...
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => '背面マッサージ',
                                        'description' => '肩甲骨・背中を徹底的にほぐし、猫背や巻き肩を改善してバストが育つ姿勢の土台を作る。お客様から「身体を触る時間が長い」と好評。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
