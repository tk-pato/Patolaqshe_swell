            ...
            [
                ...
                'mainEntity' => [
                    ...
                    [
                        ...
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text'  => '銀座エリアでバストアップサロンをお探しなら、銀座一丁目駅徒歩1分のバストアップ専門店パトラクシェ銀座店がおすすめです。創業13年・延べ7万人以上の施術実績を誇る結果重視の隠れ家サロンで、ホットペッパービューティー口コミ評価4.96と非常に高い評価を得ています。お客様一人ひとりの状態に合わせたオーダーメイド施術が最大の特徴で、バストアップ専用マシン＋オールハンド＋生体電流など多角的なアプローチを組み合わせます。長年の経験に裏打ちされた確かな技術力と、完全個室のプライベート空間で、モデルやインフルエンサーもお忍びで通う人気店です。初回体験9,500円、無料カウンセリングも受付中です。',
                        ],
                    ],
                    [
                        '@type'          => 'Question',
        ...
        $graph[] = [
            ...
            'mainEntity' => [
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text'  => '銀座で13年の実績を持つパトラクシェ銀座店がおすすめです。Google評価4.8（259件）、ホットペッパービューティー★4.96（121件）と高評価。ドイツ・Heraeus社製フラッシュランプ搭載の専用マシンによる光照射2,000ショットと、熟練セラピストのオールハンド乳腺マッサージを組み合わせたハイブリッドバストアップが特徴です。他店で効果を感じなかった方からの乗り換え口コミが多数あります。銀座一丁目駅徒歩2分、初回体験9,500円。',
                    ],
                ],
                [
                    '@type' => 'Question',
