    ...
    $structured_data = [
        ...
        '@graph'   => [
            ...
            [
                ...
                'description' => '恵比寿エリアのバストアップ専門パトラクシェ恵比寿・代官山店。フラッシュバスト（光バストアップ）2000ショット・乳腺マッサージ・ナノカレント・背面マッサージ・コラーゲンマシンを組み合わせたハイブリッド施術。創業13年・累計3万人超の実績。JR恵比寿駅徒歩6分、代官山駅徒歩2分。初回体験9,500円。',
                            ...
                            'itemListElement' => [
                                [
                                    ...
                                    'itemOffered' => [
                                        ...
                                        'description' => '都内随一の2000ショット照射。光エネルギーで乳腺・脂肪細胞を活性化し、ハリとボリュームを実現。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => '乳腺マッサージ',
                                        'description' => '熟練のオールハンドで乳腺を丁寧にほぐし、バストの成長を促進。他店より施術時間が長く、お身体全体にしっかりアプローチ。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => 'ナノカレント（微弱電流）',
                                        'description' => '微弱電流で細胞レベルからバストケア。コラーゲン生成を促進し、ハリと弾力のあるバストへ導く。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => '背面マッサージ',
                                        'description' => '肩甲骨・背中を徹底的にほぐし、バストが育つ姿勢の土台を作る。お客様から「身体を触る時間が長い」と好評。',
                                    ],
                                ],
                                [
                                    '@type' => 'Offer',
                                ...
                                [
                                    ...
                                    'itemOffered' => [
                                        '@type'       => 'Service',
                                        'name'        => 'コラーゲンマシン',
                                        'description' => '可視光線でコラーゲン生成を促進し、バストのハリ・弾力アップと美肌効果を同時に実現。代官山店限定メニュー。',
                                    ],
                                ],
                            ],
                        ],
            ...
            [
                ...
                'description' => '銀座エリアのバストアップ専門パトラクシェ銀座店。フラッシュバスト（光バストアップ）2000ショット・乳腺マッサージ・ナノカレント・背面マッサージ・骨盤底筋ケアを組み合わせたハイブリッド施術。創業13年・累計3万人超の実績。銀座一丁目駅徒歩2分、JR有楽町駅徒歩5分。初回体験9,500円。',
                            ...
                            'itemListElement' => [
                                ...
                                [
                                    ...
                                    'itemOffered' => [
                                        ...
                                        'description' => '足裏の反射区刺激と骨盤底筋へのアプローチで骨盤を安定させ、姿勢を改善。骨盤底筋と胸部は筋膜・横隔膜を介して連動しており、バストアップの土台を内側から整える。銀座店限定メニュー。',
                                    ],
                                ],
                            ],
                        ],
