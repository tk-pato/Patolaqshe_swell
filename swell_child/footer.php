...
(function() {
    ...
    function initFaqModal() {
        ...
        trigger.onclick = function(e) {
            ...
            console.log('[FAQ Modal] モーダル opened');
        };
        ...
        closeBtns.forEach(function(btn) {
            btn.onclick = function(e) {
                ...
                console.log('[FAQ Modal] モーダル closed');
            };
        });
        ...
        if (bg) {
            bg.onclick = function(e) {
                if (e.target === bg) {
                    ...
                    console.log('[FAQ Modal] 背景クリックでモーダル closed');
                }
            };
        }
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape' && modal.classList.contains('js-modalitem_open')) {
                ...
                console.log('[FAQ Modal] ESCキーでモーダル closed');
            }
        });
        
        console.log('[FAQ Modal] 初期化完了');
    }
