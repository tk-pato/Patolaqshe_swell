...
!function(e, t) {
            ...
            return f(l, "_invoke", {
                value: (i = e, a = n, u = s, c = "suspendedStart", function(e, t) {
                    ...
                    for (u.method = e, u.arg = t;;) {
                        ...
                        if (n) {
                            var r = function e(t, n) {
                                var r = n.method,
                                    o = t.iterator[r];
                                if (void 0 === o)
                                    return n.delegate = null, "throw" === r && t.iterator.return && (n.method = "return", n.arg = void 0, e(t, n), "throw" === n.method) || "return" !== r && (n.method = "throw", n.arg = new TypeError("The iterator does not provide a '" + r + "' method")), h;
                        ...
                        var o = d(i, a, u);
                        if ("normal" === o.type) {
                            if (c = u.done ? "completed" : "suspendedYield", o.arg === h)
                                continue;
                            return {
                                value: o.arg,
                                done: u.done
    ...
    function O(e, t) {
        ...
        if (!e || !n || "function" != typeof n.querySelectorAll)
            return null;
        for (var r = n.querySelectorAll("iframe"), o = 0; o < r.length; o++)
            if (r[o] && r[o].contentWindow === e)
                return r[o];
        return null
    }
    ...
    function R() {
        ...
        if (F(this, "_id", "_WeakMap_" + I() + "." + I()), 0 < arguments.length)
    ...
    (M = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : L).WeakMap || (C = Object.prototype.hasOwnProperty, N = Object.defineProperty && function() {
        try {
    ...
    }, M.WeakMap = (F(R.prototype, "delete", function(e) {
        if (q(this, "delete"), !V(e))
            return !1;
        var t = e[this._id];
        return !(!t || t[0] !== e) && (delete e[this._id], !0)
    }), F(R.prototype, "get", function(e) {
        if (q(this, "get"), V(e)) {
            var t = e[this._id];
            return t && t[0] === e ? t[1] : void 0
        }
    }), F(R.prototype, "has", function(e) {
        if (q(this, "has"), !V(e))
            return !1;
        var t = e[this._id];
        return !(!t || t[0] !== e)
    }), F(R.prototype, "set", function(e, t) {
        if (q(this, "set"), !V(e))
    ...
    function G(e, t, n) {
        ...
        if (!r[t])
            return !0;
        if (!n)
            return r[t] = [], W.set(e.element, r), !0;
        var o = r[t].indexOf(n);
    ...
    function Q(n, r) {
        var t,
            e,
            o = [];
        (r = Y(r)).event ? ("error" === r.event && B(n, r.data.method).forEach(function(e) {
    ...
    var $ = ["airplay", "audio_tracks", "audiotrack", "autopause", "autoplay", "background", "byline", "cc", "chapter_id", "chapters", "chromecast", "color", "colors", "controls", "dnt", "end_time", "fullscreen", "height", "id", "initial_quality", "interactive_params", "keyboard", "loop", "maxheight", "max_quality", "maxwidth", "min_quality", "muted", "play_button_position", "playsinline", "portrait", "preload", "progress_bar", "quality", "quality_selector", "responsive", "skipping_forward", "speed", "start_time", "texttrack", "thumbnail_id", "title", "transcript", "transparent", "unmute_button", "url", "vimeo_logo", "volume", "watch_full_video", "width"];
    function J(r, e) {
                    ...
                    if (403 !== i.status)
                        try {
                            ...
                            if (403 === e.domain_status_code)
                                return X(e, c), void n(new Error("“".concat(a, "” is not embeddable.")));
                            t(e)
                        } catch (e) {
                            n(e)
                        }
    ...
    var K,
                ...
                value: (o = h(j().mark(function e(t, n, r) {
                    ...
                    return j().wrap(function(e) {
                        for (;;)
                            ...
                            case 12:
                                a = _(n, ["seeked", "play", "pause", "ratechange"], function() {
                            ...
                            var e = h(j().mark(function e() {
                                ...
                                return j().wrap(function(e) {
                                    for (;;)
                                        ...
                                        case 11:
                                            if (e.t3 = e.sent, t = e.t2 - e.t3, n = Math.abs(t), c.log("Drift: ".concat(t)), s < n)
                                        ...
                                        case 22:
                                            if (l < n)
                                                return i = (r = n / d) < (o = f) ? (o - r) / 2 : o, e.next = 28, c.adjustSpeed(u, i * Math.sign(t));
                                            e.next = 29;
                                            break;
                                        case 28:
        ...
        Player = function() {
            function Player(u) {
                ...
                if ("IFRAME" === u.nodeName || (t = u.querySelector("iframe")) && (u = t), "IFRAME" === u.nodeName && !x(u.getAttribute("src") || ""))
                ...
                this.origin = "*";
                var r,
                    o = new U(function(i, a) {
                        var e;
                        c._onMessage = function(e) {
                            if (x(e.origin) && c.element.contentWindow === e.source) {
                        ...
                        "IFRAME" !== c.element.nodeName && Z(T(e = J(u, n)), e, u).then(function(e) {
                            var t,
                                n,
                                r,
                                o = X(e, u);
                            return c.element = o, c._originalElement = u, t = u, n = o, r = W.get(t), W.set(n, r), W.delete(t), oe.set(c.element, c), e
                        }).catch(a)
                    });
                return ie.set(this, o), oe.set(this.element, this), "IFRAME" === this.element.nodeName && H(this, "ping"), ae.isEnabled && (r = function() {
                    return ae.exit()
                }, this.fullscreenchangeHandler = function() {
                    (ae.isFullscreen ? z : G)(c, "event:exitFullscreen", r),
                    c.ready().then(function() {
                        H(c, "fullscreenchange", ae.isFullscreen)
                    })
                }, ae.on("fullscreenchange", this.fullscreenchangeHandler)), this
            }
            var n;
            return e(Player, [{
                key: "callMethod",
                value: function(n) {
                    for (var r = this, e = arguments.length, o = new Array(1 < e ? e - 1 : 0), t = 1; t < e; t++)
                        o[t - 1] = arguments[t];
                    if (null == n)
                ...
                value: function(n) {
                    var r = this;
                    return new U(function(e, t) {
                        return n = E(n, "get"), r.ready().then(function() {
                            z(r, n, {
                                resolve: e,
                                reject: t
                            }),
                ...
                key: "ready",
                value: function() {
                    var e = ie.get(this) || new U(function(e, t) {
                ...
                value: function() {
                    return ae.isEnabled ? ae.request(this.element) : this.callMethod("requestFullscreen")
                }
            }, {
                key: "exitFullscreen",
                value: function() {
                    return ae.isEnabled ? ae.exit() : this.callMethod("exitFullscreen")
                }
            }, {
                key: "getFullscreen",
                value: function() {
                    return ae.isEnabled ? U.resolve(ae.isFullscreen) : this.get("fullscreen")
                }
            }, {
                ...
                value: function() {
                    ...
                    return new U(function(e) {
                        ...
                        ie.delete(n),
                        oe.delete(n.element),
                        n._originalElement && (oe.delete(n._originalElement), n._originalElement.removeAttribute("data-vimeo-initialized")),
                        ...
                        n.element && "DIV" === n.element.nodeName && n.element.parentNode && (n.element.removeAttribute("data-vimeo-initialized"), (t = n.element.querySelector("iframe")) && t.parentNode && (t.parentNode.parentNode && n._originalElement && n._originalElement !== t.parentNode ? t.parentNode.parentNode.removeChild(t.parentNode) : t.parentNode.removeChild(t))),
                        n._window.removeEventListener("message", n._onMessage),
                        ae.isEnabled && ae.off("fullscreenchange", n.fullscreenchangeHandler),
                        e()
                    })
                }
            }, {
                ...
                value: (n = h(j().mark(function e(t, n) {
                    ...
                    return j().wrap(function(e) {
                        for (;;)
                            ...
                            case 4:
                                return r = new re(this, t, n), H(this, "notifyTimingObjectConnect"), r.addEventListener("disconnect", function() {
                                    return H(o, "notifyTimingObjectDisconnect")
                                }), e.abrupt("return", r);
                            case 8:
                            case "end":
                                return e.stop()
    ...
    return k || (K = function() {
        ...
        request: function(o) {
            return new Promise(function(e, t) {
                function n() {
                    te.off("fullscreenchange", n),
                    e()
                }
                te.on("fullscreenchange", n);
        ...
        exit: function() {
            return new Promise(function(t, e) {
                var n,
                    r;
                te.isFullscreen ? (n = function e() {
                    te.off("fullscreenchange", e),
                    t()
                }, te.on("fullscreenchange", n), (r = document[K.exitFullscreen]()) instanceof Promise && r.then(n).catch(e)) : t()
            })
        },
        on: function(e, t) {
            var n = ee[e];
        ...
        window.VimeoPlayerResizeEmbeds_ || (window.VimeoPlayerResizeEmbeds_ = !0, window.addEventListener("message", function(e) {
            var t;
            x(e.origin) && (!e.data || "spacechange" !== e.data.event || (t = e.source ? O(e.source, n) : null) && (t.parentElement.style.paddingBottom = "".concat(e.data.data[0].bottom, "px")))
        }))
    }(), function(e) {
        ...
        window.VimeoSeoMetadataAppended || (window.VimeoSeoMetadataAppended = !0, window.addEventListener("message", function(e) {
            var t,
                n;
            x(e.origin) && (!(t = Y(e.data)) || "ready" !== t.event || (n = e.source ? O(e.source, r) : null) && P(n.src) && new Player(n).callMethod("appendVideoMetadata", window.location.href))
        }))
    }(), function(e) {
        var o,
            i = 0 < arguments.length && void 0 !== e ? e : document;
        window.VimeoCheckedUrlTimeParam || (window.VimeoCheckedUrlTimeParam = !0, o = function(e) {
            "console" in window && console.error && console.error("There was an error getting video Id: ".concat(e))
        }, window.addEventListener("message", function(e) {
            var t,
                n,
                r;
            x(e.origin) && (!(t = Y(e.data)) || "ready" !== t.event || (n = e.source ? O(e.source, i) : null) && P(n.src) && (r = new Player(n)).getVideoId().then(function(e) {
                var t,
                    n = new RegExp("[?&]vimeo_t_".concat(e, "=([^&#]*)")).exec(window.location.href);
        ...
        if (x(e.origin)) {
            ...
            if (t && "drminitfailed" === t.event) {
                var n = e.source ? O(e.source) : null;
                if (n) {
                    var r = n.getAttribute("allow") || "";
                    if (!r.includes("encrypted-media")) {
                        n.setAttribute("allow", "".concat(r, "; encrypted-media"));
                        var o = new URL(n.getAttribute("src"));
                        return o.searchParams.set("forcereload", "drm"), void n.setAttribute("src", o.toString())
                    }
                }
            }
        }
