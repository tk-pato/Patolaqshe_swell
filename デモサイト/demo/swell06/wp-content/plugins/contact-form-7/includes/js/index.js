(() => {
    ...
    const e = window.wp.i18n,
        ...
        r = e => {
            ...
            return c.reduceRight(((e, t) => a => t(a, e)), (e => {
                ...
                "string" == typeof s && (n = a.replace(/^\/|\/$/g, ""), r = s.replace(/^\//, ""), o = r ? n + "/" + r : n),
                "string" == typeof o && (-1 !== t.indexOf("?") && (o = o.replace("?", "&")), o = o.replace(/^\//, ""), c = t + o),
                i = {
    ...
    function p(e, t={}) {
        if (wpcf7.blocked)
            return d(e), void n(e, "submitting");
        ...
        (e => {
            e.querySelectorAll(".wpcf7-validates-as-url").forEach((e => {
                e.addEventListener("change", (t => {
                    let a = e.value.trim();
                    a && !a.match(/^[a-z][a-z0-9.+-]*:/i) && -1 !== a.indexOf(".") && (a = a.replace(/^\/+/, ""), a = "http://" + a),
                    e.value = a
                }))
            }))
        })(e),
