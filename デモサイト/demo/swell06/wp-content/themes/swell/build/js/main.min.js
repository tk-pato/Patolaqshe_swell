!function() {
    var e = {
            ...
            614: function(e, t, n) {
                ...
                const r = {
                    ...
                    toggleSearch() {
                        ...
                        if (null === e)
                            return !1;
                        e.classList.contains("is-opened") ? e.classList.remove("is-opened") : (e.classList.add("is-opened"), setTimeout((() => {
                    ...
                    clickLink(e) {
                        ...
                        "mousedown" === e.type ? 1 === e.button && window.open(t.getAttribute("href")) : (t.onclick = e => (e.stopPropagation(), !0), t.click())
                    }
                };
                function i(e) {
                ...
                const f = navigator.userAgent.toLowerCase(),
                    ...
                    w = () => {
                        var e,
                            t,
                            n;
                        null !== (e = o.Z.header) && (l = e.offsetHeight, document.documentElement.style.setProperty("--swl-headerH", l + "px")),
                        null !== (t = o.Z.fixHeader) && (r = t.offsetHeight, document.documentElement.style.setProperty("--swl-fix_headerH", r + "px")),
                        n = o.Z.wpadminbar,
                        u = 0,
                        i ? u += r : !i && a && (u += l),
            ...
            290: function(e, t, n) {
                ...
                const d = (e, t) => {
                    ...
                    u = () => {
                        ...
                        null !== (t = window.swellVars) && void 0 !== t && t.useAjaxFooter && (d("before_footer_widget", ""), d("footer", ""))
                    }
            },
            595: function() {
            ...
            548: function(e, t, n) {
                ...
                function r() {
                    document.querySelectorAll('.wp-block-table.td_to_th_, .wp-block-table[data-cell1-fixed], table[style*="--swl-cell1-width"]').forEach((e => {
                        const t = e.querySelectorAll("tbody tr > :first-child, tbody tr:empty");
                        let n = 0;
                        t.forEach((e => {
                            if ("tr" === e.tagName)
                                n > 0 && n--;
            ...
            14: function(e, t, n) {
                ...
                function r() {
                    ...
                    if (null === d)
                        return;
                    if (null !== d.querySelector(".p-toc.-called-from-sc") && c.classList.remove("-index-off"), c.classList.contains("-index-off"))
                        return;
                    ...
                    const {listHtml: b, isOmitted: E} = function({hTags: e, ignoreClasses: t, idPrefix: n="toc-", listTag: o="ol", arrowedTags: r=["ruby", "rp", "rb", "rt"], childClass: i="", linkClass: s="", prevLink: c="", nextLink: d="", omitType: u, omitNum: a=5}) {
                        ...
                        for (let c = 0; c < e.length; c++) {
                            ...
                            if (0 === d.offsetHeight)
                                continue;
                            d.hasAttribute("id") ? w = d.getAttribute("id") : (w = n + c, d.setAttribute("id", w));
                            let v = !1;
                            ...
                            if ("h2" === E ? b = 2 : "h3" === E ? b = 3 : "h4" === E ? b = 4 : "h5" === E && (b = 5), 0 === b)
                                continue;
                            if ("" === p && 2 !== b)
                                continue;
                            if (1 < b - m)
                            ...
                            if (m < b)
                                ...
                                for (; m > b;)
                                    ...
                                    m--;
                            let x = "";
                            "" === u ? x = "" : "nest" === u && 2 < m ? f = !0 : "ct" === u && a < h ? (x = ' data-omit="1"', f = !0) : "both" === u && (2 === m && a < g ? x = ' data-omit="1"' : 2 < m && g--, a < h && (f = !0)),
                    ...
                    y && A && (A.setAttribute("data-omit", g), A.classList.add("is-omitted"));
                    ...
                    if (y) {
                        ...
                        if (n) {
                            ...
                            o.addEventListener("click", (() => {
                                A.classList.contains("is-expanded") ? (A.classList.add("is-omitted"), A.classList.remove("is-expanded"), o.innerHTML = t) : (A.classList.remove("is-omitted"), A.classList.add("is-expanded"), o.innerHTML = e)
                            }))
                        }
                    }
                }
    ...
    function() {
        ...
        window.addEventListener("load", (function() {
            if (document.documentElement.setAttribute("data-loaded", "true"), (0, o.QW)(), null !== e.Z.fixSidebar && (0, r.Z)(e.Z.fixSidebar), (0, u.B)(), m) {
                const e = m.replace("#", ""),
