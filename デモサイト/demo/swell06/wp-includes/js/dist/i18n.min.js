    ...
    var t = {
            2058: (t, e, r) => {
                ...
                !function() {
                        ...
                        return function(t, e) {
                            ...
                            for (n = 0; n < h; n++)
                                if ("string" == typeof t[n])
                                    ...
                                    if (i.not_type.test(s.type) && i.not_primitive.test(s.type) && r instanceof Function && (r = r()), i.numeric_arg.test(s.type) && "number" != typeof r && isNaN(r))
                    ...
                    e.sprintf = a,
                    e.vsprintf = o,
                    "undefined" != typeof window && (window.sprintf = a, window.vsprintf = o, void 0 === (n = function() {
                        return {
                            sprintf: a,
                            vsprintf: o
                        }
